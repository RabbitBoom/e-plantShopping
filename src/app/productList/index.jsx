...
import "./index.css";
import CartItem from "app/cart/index";

import { useDispatch, useSelector } from "react-redux";
import { addItem, updateQuantity } from "store/CartSlice.jsx";
              ...
              <div className="product-list">
                {category.plants.map((plant, plantIndex) => (
                  <div className="product-card" key={plantIndex}>
                    <img
                      className="product-image m-b-20"
                      src={plant.image}
                      alt={plant.name}
                    />
                    <div className="product-title">{plant.name}</div>
                    <div className="product-description m-b-15">
                      {plant.description}
                    </div>
                    <div className="product-cost m-b-15">${plant.cost}</div>
                    <button
